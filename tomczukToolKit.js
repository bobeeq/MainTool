...
class WholesaleEl {
    ...
    createTable() {
        ...
        this.btn.innerHTML = this.btn.innerHTML.replace(/\(\d+\)/, `(${this.totalQty})`);
    ...
    if( ! cbaMachine) {
        return [
          ...
          },
          {
            ...
            "w_koszykach_z_zapasu": 0,
            "w_kolejce": 0,
            "na_mag_i_zapas_z_kolejka": 124
          },
          {
            "tytul": "Pucio uczy się mówić. Zabawy dźwiękonaśladowcze dla najmłodszych",
            "model": "9788310135971",
            "ean": "9788310135971",
